...
const Login = ({setToken}) => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center w-full'>
      <div className='bg-white shadow-md rounded-lg px-6 py-6 max-w-md'>
        ...
        <form onSubmit={onSubmitHandler}>
            ...
            <button className='mt-2 w-full rounded-md text-white bg-black py-2 px-4 cursor-pointer' type='submit'>Login</button>
        </form>
      </div>
    </div>
  )
